...
# r.load('./models/bench2.obj',(-0.9, -2.15, 0), (0.007, 0.007, 0.0001),(0, 1.5, 0), texture=t, normal = n)
...
r.load('./models/espada.obj',(-2.1, -1.5, 0), (0.12, 0.12, 0.12),(0, 0, 1.9), texture=t, normal = n)
